...
//
// Jonker-Volgenant dense linear-assignment solver. Numerical kernel kept close
// to upstream on purpose; do not hand-edit variable names. Reformatting only.
...
// Vendored numerical kernel, exempt from this repo's naming and modernize
 ...
 */
int _ccrrt_dense(const size_t n, double *cost[], int *free_rows, int *x, int *y, double *v) {
    int n_free_rows;
    bool *unique;
 ...
 */
int _carr_dense(const size_t n, double *cost[], const size_t n_free_rows, int *free_rows, int *x,
                int *y, double *v) {
    size_t current = 0;
    int new_free_rows = 0;
    size_t rr_cnt = 0;
...
int _scan_dense(const size_t n, double *cost[], size_t *plo, size_t *phi, double *d, int *cols,
                int *pred, int *y, double *v) {
    size_t lo = *plo;
    size_t hi = *phi;
    double h, cred_ij;
 ...
 */
int find_path_dense(const size_t n, double *cost[], const int start_i, int *y, double *v,
                    int *pred) {
    size_t lo = 0, hi = 0;
    int final_j = -1;
    size_t n_ready = 0;
 ...
 */
int _ca_dense(const size_t n, double *cost[], const size_t n_free_rows, int *free_rows, int *x,
              int *y, double *v) {
    int *pred;
